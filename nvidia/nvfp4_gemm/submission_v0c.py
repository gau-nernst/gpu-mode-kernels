...
template <int BLOCK_K, int TRANSPOSE, int NUM_STAGES, bool DO_PROFILE>
__global__
...
void gemm_launch(
  ...
  auto this_kernel = kernel<BLOCK_K, TRANSPOSE, NUM_STAGES, DO_PROFILE>;
  if (smem_size > 48'000)
...
at::Tensor gemm(
  ...
  gemm_launch<256, true, 6, false>(A_ptr, B_ptr, SFA_ptr, SFB_ptr, C_ptr, M, N, K, nullptr, 0);
  return C;
}
...
at::Tensor profile(
  ...
  gemm_launch<256, true, 6, true>(A_ptr, B_ptr, SFA_ptr, SFB_ptr, C_ptr, M, N, K, profiler_ptr, num_entries);
  return C;
}
...
if DO_PROFILE:
    cuda_cflags.append("-DPLEASE_PROFILE")
